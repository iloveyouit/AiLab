...
- CSS Modules for styling (no Tailwind). Inline styles are acceptable only for dynamic positioning (e.g., `position: fixed` dropdowns computed via `getBoundingClientRect()`)
